...
[![Status](https://img.shields.io/badge/release-v0.11.4%20(alpha)-orange?style=flat-square)](#roadmap)
...
GunWall is an **early alpha (v0.11.4)**. The core engine, real-time monitoring, connection alerts and full-control mode are functional and fast, but this is a foundation under active development — not yet a hardened production security product. Test it in a safe environment first.
